...
import { NodebootOauth2StarterService, Part, Option } from '../../nodeboot-oauth2-starter.service';
...
export declare class ApplicationOptionsComponent implements OnInit {
    ...
    constructor(dialogRef: MatDialogRef<ApplicationOptionsComponent>, formBuilder: FormBuilder, nbService: NodebootOauth2StarterService, part: Part);
    ngOnInit(): void;
