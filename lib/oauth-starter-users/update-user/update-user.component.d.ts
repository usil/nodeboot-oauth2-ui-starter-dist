...
export declare class UpdateUserComponent implements OnInit {
    ...
    constructor(formBuilder: UntypedFormBuilder, dialogRef: MatDialogRef<UpdateUserComponent>, nbService: NodebootOauth2StarterService, user: User);
    closeDialog(): void;
    updateUser(updateUserData: UserUpdateBody): void;
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<UpdateUserComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<UpdateUserComponent, "lib-update-user", never, {}, {}, never, never, false>;
}
