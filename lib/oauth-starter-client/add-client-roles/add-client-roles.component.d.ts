...
export declare class AddClientRolesComponent implements OnInit {
    ...
    roles: BasicRole[];
    rolesList: BasicRole[];
    constructor(dialogRef: MatDialogRef<AddClientRolesComponent>, formBuilder: UntypedFormBuilder, nbService: NodebootOauth2StarterService, client: Client);
    ngOnInit(): void;
    addRoleToList(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<AddClientRolesComponent, "lib-add-client-roles", never, {}, {}, never, never, false>;
}
