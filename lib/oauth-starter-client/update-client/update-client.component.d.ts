...
export declare class UpdateClientComponent implements OnInit {
    ...
    constructor(formBuilder: UntypedFormBuilder, dialogRef: MatDialogRef<UpdateClientComponent>, nbService: NodebootOauth2StarterService, client: Client);
    closeDialog(): void;
    updateUser(updateClientData: ClientUpdateBody): void;
    ngOnInit(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<UpdateClientComponent, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<UpdateClientComponent, "lib-update-client", never, {}, {}, never, never, false>;
}
