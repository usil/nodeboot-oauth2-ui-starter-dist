...
export declare class ChangePasswordComponent implements OnInit {
    ...
    constructor(formBuilder: UntypedFormBuilder, dialogRef: MatDialogRef<ChangePasswordComponent>, nbService: NodebootOauth2StarterService, user: User);
    ngOnInit(): void;
    closeDialog(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ChangePasswordComponent, "lib-change-password", never, {}, {}, never, never, false>;
}
